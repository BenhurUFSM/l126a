...
---: | :--- | ---: | :---
1 | ESCR | 3 | `ES[M[PC+2]] ← M[M[PC+1]]` ; `PC ← PC+3`
2 | LE | 3 | `M[M[PC+2]]` ← `ES[M[PC+1]]` ; `PC ← PC+3`
3 | SOMA | 4 | `M[M[PC+3]] ← M[M[PC+1]] + M[M[PC+2]]` ; `PC ← PC+4`
4 | SUB | 4 | `M[M[PC+3]] ← M[M[PC+1]] - M[M[PC+2]]` ; `PC ← PC+4`
5 | DIV | 4 | `M[M[PC+3]] ← M[M[PC+1]] ÷ M[M[PC+2]]` ; `PC ← PC+4`
6 | MULT | 4 | `M[M[PC+3]] ← M[M[PC+1]] × M[M[PC+2]]` ; `PC ← PC+4`
7 | DESV | 2 | `PC ← M[PC+1]`
8 | DESVM | 4 | se `M[M[PC+1]]` > `M[M[PC+2]]` então `PC ← M[PC+3]` senão `PC ← PC+4`
